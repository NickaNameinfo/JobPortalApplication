...
<body>
    ...
    <div class="create-account-area pt-50 pb-50">
        <div class="container">
            <div class="create-photo">
                <div class="already-create text-center">
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="create-photo-item text-center">
                                <h5>Post a Job</h5>
                                ...
                                <div class="create-photo-right">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Job Eligibilty">
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <textarea name="" id="" cols="30" rows="10" class="form-control" placeholder="Job Description"></textarea>
                                    </div>
                                    <div class="text-right submitt">
                                        <button type="submit" class="btn create-photo-btn"><a
                                                href="postjob.php">Post</a> </button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from templates.hibootstrap.com/gable/default/create-account.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Sep 2023 06:53:06 GMT -->
