    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-square">
     <rect x="3" y="3" width="18" height="18" rx="2" ry="2" /></svg>
                ...
                <div class="wrapper">
                    ...
                    <div class="main-container jobsss">
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="search-type">
                                    <div class="tab">
                                        <button class="tablinks search-buttons card-buttons"
                                            onclick="openCity(event, 't4')" id="defaultOpen">My Profile</button>
                                        <button class="tablinks search-buttons card-buttons"
                                            onclick="openCity(event, 't1')">Applied Jobs</button>
                                        <button class="tablinks search-buttons card-buttons"
                                            onclick="openCity(event, 't2')">Saved Jobs</button>
                                        <button class="tablinks search-buttons card-buttons"
                                            onclick="openCity(event, 't3')">Notification</button>
                                        <button class="tablinks search-buttons card-buttons"
                                            onclick="openCity(event, 't6')">Help</button>
                                        <button class="tablinks search-buttons card-buttons"
                                            onclick="openCity(event, 't7')">Settings</button>
                                        <button class="tablinks search-buttons card-buttons"
                                            onclick="openCity(event, 't5')">Logout</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-9">
                                <div class="searched-jobs">
                                    <!-- <div class="searched-bar">
                                        ...
                                        <div class="searched-sort">Sort by: <span class="post-time">Newest Post
                                            </span><span class="menu-icon">▼</span></div>
                                    </div> -->

                                    <div id="t1" class="tabcontent">
                                        
                                    <div class="job-area job-area-two">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="job-item">
                                                        ...
                                                        <div class="job-inner align-items-center">
                                                            <div class="job-inner-left">
                                                                <h3>
                                                                    <a href="job-details.html">UI/UX
                                                                        Designer</a>
                                                                </h3>
                                                                <a class="company"
                                                                    href="company-details.html">Winbrans.com</a>
                                                                <ul>
                                                                    <li>
                                                    ...
                                                    <div class="apply"><i class="icofont-book-mark1"></i> Applied</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="job-item">
                                                        ...
                                                        <div class="job-inner align-items-center">
                                                            <div class="job-inner-left">
                                                                <h3><a href="job-details.html">Android
                                                                        Developer</a></h3>
                                                                <a class="company"
                                                                    href="company-details.html">Infiniza.com</a>
                                                                <ul>
                                                                    <li>
                                                                        <i class="icofont-money-bag"></i>
                                                                        $20k - $25k
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="job-item">
                                                        ...
                                                        <div class="job-inner align-items-center">
                                                            <div class="job-inner-left">
                                                                <h3>
                                                                    <a href="job-details.html">Senior
                                                                        Manager</a>
                                                                </h3>
                                                                <a class="company"
                                                                    href="company-details.html">Glovibo.com</a>
                                                                <ul>
                                                                    <li>
                                                                        <i class="icofont-money-bag"></i>
                                                                        $20k - $25k
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="job-item ">
                                                        ...
                                                        <div class="job-inner align-items-center">
                                                            <div class="job-inner-left">
                                                                <h3>
                                                                    <a href="job-details.html">Product
                                                                        Designer</a>
                                                                </h3>
                                                                <a class="company"
                                                                    href="company-details.html">Bizotic.com</a>
                                                                <ul>
                                                                    <li>
                                                                        <i class="icofont-money-bag"></i>
                                                                        $20k - $25k
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="job-item">
                                                        ...
                                                        <div class="job-inner align-items-center">
                                                            <div class="job-inner-left">
                                                                <h3>
                                                                    <a href="job-details.html">Digital
                                                                        Marketer</a>
                                                                </h3>
                                                                <a class="company"
                                                                    href="company-details.html">Hotelzo.com</a>
                                                                <ul>
                                                                    <li>
                                                                        <i class="icofont-money-bag"></i>
                                                                        $20k - $25k
                                                    ...
                                                    <div class="job-item">
                                                        ...
                                                        <div class="job-inner align-items-center">
                                                            <div class="job-inner-left">
                                                                ...
                                                                <a class="company"
                                                                    href="company-details.html">Gozuto.com</a>
                                                                <ul>
                                                                    <li>
                                                                        <i class="icofont-money-bag"></i>
                                                                        $20k - $25k
                                    ...
                                    <div id="t4" class="tabcontent">
                                        <div class="dashboard-area">
                                            <div class="create-information create-education create-education-two">
                                                ...
                                                <form>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label>Enter Highest Qualification:</label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="B.Tech">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="gender-area">
                                                                    ...
                                                                    <input type="radio" name="gender" id="male"
                                                                        value="male" checked>
                                                                    <label for="male">Fresher</label>
                                                                    <input type="radio" name="gender" id="female"
                                                                        value="female">
                                                                    <label for="female">Experience</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                        ...
                                                        <p class="textleft">Upload Your Resume</p>
                                                        <div class="form-group">
                                                            <input type="file" class="form-control filee"
                                                                placeholder="">
                                                        </div>
                                                        <!--<div class="col-lg-12">-->
                                                        <!--    <div class="form-group">-->
                                        ...
                                        <div class="single-profile-area">
                                            <div class="container">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="single-profile-item">
                                                            <div class="single-profile-right">
                                                                <div class="">
                                                                    <div class="single-profile-contact contactt">
                                                                        <h3>Contact Info</h3>
                                                                        <ul>
                                                                            <li>
                                                                                <i class="icofont-ui-call"></i>
                                                                                <a href="tel:+07554332322">Call :
                                                                                    +91 9876543210</a>
                                                                            </li>
                                                                            <li>
                                                                                <i class="icofont-whatsapp"></i>
                                                                                <a href="https://wa.me/+919876543210">Whatsapp
                                                                                    :
                                                                                    +91 9876543210</a>
                                                                            </li>
                                                                            <li>
                                                                                ...
                                                                                <a
                                                                                    href="#!"><span>info@rishijobs.com</span></a>
                                                                            </li>
                                                                            <li>
                                                                                <i class="icofont-location-pin"></i>
                                                                                Chennai.
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="single-profile-item">
                                                            <div class="create-education-right chatt">
                                                                <a href="#">Chat Now</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div id="t7" class="tabcontent">
                                        ...
                                        <div class="dashboard-area">
                                            <div class="create-information create-education create-education-two">
                                                ...
                                                <div class="create-education-wrap">
                                                    <div class="create-education-left accsett">
                                                ...
                                                <form class="settings">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <a href=""><div class="icofont-edit"></div></a>
                                                            </div>
                                                        </div>
