...
CREATE TABLE `courses` (
  ...
  `company_name` varchar(255) DEFAULT NULL,
  `experince` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `courses` (`id`, `job_title`, `job_category`, `salary_from`, `salary_to`, `job_location`, `job_description`, `job_skills`, `job_qualification`, `course_status`, `create_at`, `updated_at`, `company_name`, `experince`) VALUES
('b79cf9de-46db-436f-9c07-e812438d29b1', 'ui', 'ui', '42k', '3l', 'chennai', 'test', 'teest', 'test', 'Active', '2024-01-01 10:12:17', '2024-01-01 10:12:17', NULL, ''),
('bf4bc1b7-d92a-469a-bc94-d930da75bc3a', 'test', 'ets', '5k', '7l', 'chennai', 'tets', 'test', 'tes', 'Active', '2024-01-01 10:46:34', '2024-01-01 10:46:34', 'Admin', ''),
('de055860-7499-4cd5-926a-bf64f0b5b081', 'asdf', 'dfa', 'sdfasdfa', 'fas', 'dfas', 'fasd', 'fasdf', 'f', 'sad', '2024-01-01 11:33:26', '2024-01-01 11:33:26', 'ibss', '1'),
('ee72aaaf-4637-4d7e-984d-b205050ae047', 'fdasdf', 'asdfa', 'sdfasdfas', 'dfasd', 'sdf', 'fasd', 'fasdfasdf', 'asdfasd', 'dfasd', '2024-01-01 11:16:27', '2024-01-01 11:16:27', 'ibss', '');
